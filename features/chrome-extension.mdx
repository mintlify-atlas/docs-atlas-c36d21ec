...
description: "Install the Page Agent Chrome extension for multi-tab automation, browser-level control, and tasks triggered from page JavaScript or external agents."
---
