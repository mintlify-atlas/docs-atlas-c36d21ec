...
description: "Run @page-agent/mcp to connect Claude Desktop, Cursor, or Copilot to your browser through the Page Agent extension using a local WebSocket bridge."
---
...
<Steps>
  ...
  <Step title="Launcher page triggers the extension to open a hub tab">
