...
| `config` | `PageAgentCoreConfig` | The resolved configuration object. |
...
| `pushObservation(content)` | `void` | Inject an observation string into history before the next step. Useful for testing or external monitoring hooks. |
