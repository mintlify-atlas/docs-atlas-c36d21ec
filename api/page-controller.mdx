...
```typescript
controller.scroll(options: ScrollOptions): Promise<ActionResult>
```
...
<ParamField body="options" type="object" required>
  <Expandable title="ScrollOptions fields">
    <ParamField body="down" type="boolean" default="true">
      `true` to scroll down, `false` to scroll up.
    </ParamField>
    <ParamField body="numPages" type="number" default="0.1">
...
```typescript
controller.scrollHorizontally(options: HScrollOptions): Promise<ActionResult>
```
...
<ParamField body="options" type="object" required>
  <Expandable title="HScrollOptions fields">
    <ParamField body="right" type="boolean" default="true">
