...
description: "Page Agent is a JavaScript library that embeds a GUI agent directly inside your webpage, letting users drive any web UI with natural language."
---
